...
- **Three strategies compared** — Local Only, Random Offloading, and the Proposed Adaptive Scheme
...
| Random Offloading | 120.1 ms | 0.00% | 114.84 | 54.10% |
| **Proposed Adaptive** | **148.7 ms** | **0.00%** | **44.33** | **28.21%** |

The proposed scheme achieves:
- ✅ **Zero task drop rate** (vs. 14% for local-only)
- ✅ **4.6× lower load variance** vs. local-only execution
- ✅ **2.6× lower load variance** vs. random offloading
- ✅ **28.21% offload rate** (vs. 54.10% for random — fewer unnecessary transmissions)
...
@article{haider2026iot,
  ...
  journal     = {Proceedings of IoT 2026},
  year        = {2026},
